        ...
        case 'a':
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        if (distanceA == differenceB && distanceA == distanceC && countA == countB && countA == countC)
                        {
                            elevatorAssigned = 'A';
                        }
                        else
                        {
                            ...
                            {
                                if (distanceA == differenceB && distanceA == distanceC && (countB < countA && countB < countC))
                                {
                                    elevatorAssigned = 'B';
                                }
                                else
                                {
                                    if (distanceA == differenceB && distanceA == distanceC && (countC < countA && countC < countB))
                                    {
                                        elevatorAssigned = 'C';
                                    }
                                    else
                                    {
                                        if (distanceA == distanceB && countA < countB)
                                        {
                                            elevatorAssigned = 'A';
                                        }
                                        else
                                        {
                                            if (distanceA == distanceB && countB < countA)
                                            {
                                                elevatorAssigned = 'B';
                                            }
                                            else
                                            {
                                                if (distanceA == distanceC && countA < countC)
                                                {
                                                    elevatorAssigned = 'A';
                                                }
                                                else
                                                {
                                                    if (distanceA == distanceC && countC < countA)
                                                    {
                                                        elevatorAssigned = 'C';
                                                    }
                                                    else
                                                    {
                                                        if (distanceB == distanceC && countB < countC)
                                                        {
                                                            elevatorAssigned = 'B';
                                                        }
                                                        else
                                                        {
                                                            if (distanceB == distanceC && countC < countB)
                                                            {
                                                                elevatorAssigned = 'C';
                                                            }
                                                        }
